...
\bottomrule
\end{tabular*}
\TableNote{Note: Cell2$^{*}$ is the validation cell for hyperparameter selection. All values are averaged over five experiments. CCCT, IC, DTV, and DTC correspond to HI1, HI4, HI9, and HI11, respectively.}
\end{table}
