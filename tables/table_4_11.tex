\begin{table}
\TableStyle
\caption{Effects of DSConv-S and DSConv-L configurations.}
\label{tab:4-11}
\begin{tabularx}{\linewidth}{@{\extracolsep{\fill}}L{0.90}C{0.90}C{1.05}C{1.05}C{0.60}C{1.125}C{1.125}C{1.125}C{1.125}@{}}
\toprule
Dataset & Model & DSConv-S & DSConv-L & RAA & MAE & RMSE & MAPE & Average \\
\midrule
