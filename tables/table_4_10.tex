...
\bottomrule
\end{tabularx}
\TableNote{Average denotes the arithmetic mean of MAE, RMSE, and MAPE; Reduction denotes the relative decrease in Average achieved by M4 with respect to the corresponding ablation variant.}
\end{table}
