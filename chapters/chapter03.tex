...
Small-kernel DSConv-S uses a compact $1\times5$ depthwise convolution and is embedded in LGFA before the global interactions in RAA. It serves two roles: input enhancement and local feature preservation:
